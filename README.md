...
Body 
    ...
    - Backend
        ...
        - npm intsall pm2 -g
        - pm2 start npm --name "connection-backend" -- start
        - pm2 logs
...
# Ngxinx config: 
        ...
        Domain name = connection.com => 43.204.96.49

        Frontend = connection.com
        Backend = connection.com:7777 => conection.com/api
...
# Addding a custom Domain name
    ...
    - DNS record: A connection.in 43.204.96.49
